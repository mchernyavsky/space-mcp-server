...
class SpaceMcpServer {
    ...
    private fun registerTools(server: Server) {
        ...
        server.addTool(
            ...
            respond {
                val arguments = request.argumentsOrEmpty()
        ...
        server.addTool(
            ...
            respond {
                apiClient.listProjects(
                    term = request.argumentsOrEmpty().optionalString("term"),
                    limit = request.argumentsOrEmpty().optionalInt("limit") ?: 50,
                    offset = request.argumentsOrEmpty().optionalInt("offset") ?: 0,
                )
            }
        }
